...
function link(r){return safeLink(r.link)?`<a class="job-link" href="${esc(safeLink(r.link))}" target="_blank" rel="noopener noreferrer" aria-label="Open posting for ${esc(r.company+' '+r.role)}">Posting ↗</a>`:'<span class="subtext">No link</span>';}
